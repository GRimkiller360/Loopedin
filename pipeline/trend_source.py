...
# for why this was narrowed from the original 10 to one coherent niche, and why
# psychology was later dropped from that narrowed set too (2026-08-19, user decision).
SEED_CATEGORIES = [
